/*
exchange categories are as follows:

0 : federal
1 : state

age categories are as follows: (The number on left corresponds to array position)
...
race categories are as follows: (The number on left corresponds to array position)
...
plan categories are as follows: (The number on left corresponds to array position)

0 : bronze
1 : silver
2 : gold
3 : platinum
4 : catastrophicBronze
...
var statesData = {
    ...
    "features": [{
        ...
        "properties": {
            "name": "Alabama",
            "exchange": 0,
            "race": [0.3, 6.1, 0.1, 29.9, 1.5, 60.9, 1.3],
			"plan": [8,75, 10, 6, 2],            
			"age": [2, 11, 18, 18, 22, 30, 0]
        },
        ...
        "properties": {
            "name": "Alaska",
            "exchange": 0,
            "race": [1.1, 10, 0.6, 2.7, 3.9, 78.9, 2.9],
			"plan": [26, 64, 10, 0, 1],
			"age": [7, 8, 21, 16, 20, 28, 0]
        },
        ...
        "properties": {
            "name": "Arizona",
            "exchange": 0,
            "race": [0.6, 6.9, 0.2, 3.9, 24.2, 62.3, 2],
"plan": [11, 55, 17, 17, 1],            
"age": [19, 7, 12, 14, 18, 30, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Arkansas",
            "exchange": 0,
            "race": [0.6, 3.3, 0.1, 12.7, 3.2, 78.9, 1.2],
"plan": [17, 67, 16, 0, 1],            
"age": [5, 8, 14, 16, 23, 35, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [8, 9, 13, 13, 23, 33, 1]
        ...
        "properties": {
            "name": "Delaware",
            "exchange": 0,
            "race": [0.1, 8.1, -1, 20.7, 6.3, 62.9, 1.9],
"plan": [13, 55, 23, 8, 1],            
"age": [9, 6, 14, 15, 22, 33, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [8, 7, 38, 20, 14, 13, 4]
        ...
        "properties": {
            "name": "Florida",
            "exchange": 0,
            "race": [0.2, 6.2, 0.1, 19.8, 19.2, 53.5, 1],
"plan": [13, 70, 7, 10, 1],            
"age": [4, 11, 13, 17, 26, 30, 1]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Georgia",
            "exchange": 0,
            "race": [0.1, 14.8, 0.1, 38.6, 3.6, 41.4, 1.4],
"plan": [10, 66, 9, 13, 2],            
"age": [4, 11, 17, 19, 23, 25, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [11, 6, 13, 14, 19, 33, 4]
        ...
        "properties": {
            "name": "Illinois",
            "exchange": 0,
            "race": [0.1, 9.5, 0.1, 10.5, 9.5, 69.1, 1.2],
"plan": [24, 56, 19, 1, 0],            
"age": [5, 9, 16, 14, 22, 34, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Indiana",
            "exchange": 0,
            "race": [0.2, 4.8, -1, 10.1, 3.2, 80.6, 1.1],
"plan": [25, 68, 7, 0, 1],            
"age": [6, 8, 15, 15, 21, 35, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Iowa",
            "exchange": 0,
            "race": [0.2, 3.2, -1, 3.1, 4, 88.3, 1.1],
"plan": [22, 58, 14, 5, 1],            
"age": [3, 8, 16, 15, 22, 35, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Kansas",
            "exchange": 0,
            "race": [0.6, 5.6, 0.1, 6.7, 7.2, 77.6, 2.2],
"plan": [17, 58, 20, 3, 2],            
"age": [6, 10, 19, 16, 19, 30, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [10, 8, 14, 16, 22, 30, 0]
        ...
        "properties": {
            "name": "Louisiana",
            "exchange": 0,
            "race": [0.4, 7.9, -1, 37.9, 2.2, 50.2, 1.3],
"plan": [17, 63, 11, 8, 1],            
"age": [3, 10, 19, 17, 22, 29, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Maine",
            "exchange": 0,
            "race": [0.3, 1.5, -1, 0.7, 0.6, 95.9, 1],
"plan": [17, 73, 10, 0, 1],            
"age": [8, 7, 12, 12, 22, 39, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [13, 8, 21, 15, 19, 22, 1]
        ...
        "properties": {
            "name": "Michigan",
            "exchange": 0,
            "race": [0.4, 4.6, -1, 13, 2.4, 78, 1.5],
"plan": [11, 74, 11, 2, 1],            
"age": [5, 10, 16, 14, 22, 32, 0]
        },
        "geometry": {"type": "MultiPolygon",
            "coordinates": [
                [
...
"age": [10, 6, 16, 14, 19, 34, 0]
        ...
        "properties": {
            "name": "Mississippi",
            "exchange": 0,
            "race": [0.1, 5.1, -1, 59.5, 1.2, 33.3, 0.7],
"plan": [8, 76, 6, 10, 1],            
"age": [3, 11, 15, 17, 23, 31, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Missouri",
            "exchange": 0,
            "race": [0.3, 4.3, 0.1, 12.7, 2.2, 78.8, 1.6],
"plan": [19, 62, 17, 0, 2],            
"age": [4, 10, 18, 16, 22, 31, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Montana",
            "exchange": 0,
            "race": [1.7, 1.2, 0.1, 0.3, 1.9, 93.3, 1.6],
"plan": [25, 55, 12, 8, 1],            
"age": [6, 8, 18, 15, 19, 34, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Nebraska",
            "exchange": 0,
            "race": [0.5, 3.1, 0.1, 4.2, 6.1, 84.7, 1.3],
"plan": [21, 60, 10, 8, 1],            
"age": [10, 10, 17, 16, 19, 27, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [9, 7, 15, 17, 19, 29, 3]
        ...
        "properties": {
            "name": "New Hampshire",
            "exchange": 0,
            "race": [0.1, 4.0, -1, 1.1, 1.3, 92.4, 1.1],
"plan": [23, 59, 17, 0, 1],            
"age": [5, 8, 16, 14, 23, 34, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "New Jersey",
            "exchange": 0,
            "race": [0.1, 16.3, 0.1, 13.2, 6.7, 62.3, 1.2],
"plan": [12, 68, 16, 4, 1],            
"age": [5, 9, 14, 16, 25, 30, 1]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "New Mexico",
            "exchange": 0,
            "race": [2.5, 3.7, 0.1, 1.7, 31.1, 59.5, 1.5],
"plan": [21, 61, 17, 1, 1],            
"age": [7, 6, 13, 14, 23, 36, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [3, 9, 19, 17, 24, 28, 0]
        ...
        "properties": {
            "name": "North Carolina",
            "exchange": 0,
            "race": [0.6, 4.9, 0.1, 23.4, 3, 66.7, 1.3],
"plan": [15, 74, 7, 4, 1],            
"age": [6, 10, 16, 17, 22, 29, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "North Dakota",
            "exchange": 0,
            "race": [1.0, 1.8, -1, 1.4, 1.3, 93.1, 1.4],
"plan": [16, 44, 39, 0, 1],            
"age": [18, 8, 18, 14, 16, 28, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Ohio",
            "exchange": 0,
            "race": [0.1, 4, -1, 11.5, 1.8, 81.1, 1.5],
"plan": [22, 58, 16, 2, 1],            
"age": [8, 7, 14, 14, 21, 36, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Oklahoma",
            "exchange": 0,
            "race": [3.1, 6.8, 0.1, 9, 7.5, 70.1, 3.4],
"plan": [21, 66, 11, 2, 1],            
"age": [5, 10, 17, 17, 21, 30, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [5, 6, 13, 14, 21, 41, 0]
        ...
        "properties": {
            "name": "Pennsylvania",
            "exchange": 0,
            "race": [0.1, 9.1, 0.1, 12.3, 3.4, 73.7, 1.3],
"plan": [7, 69, 15, 9, 1],            
"age": [3, 9, 17, 15, 22, 34, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [5, 10, 16, 16, 23, 29, 1]
        ...
        "properties": {
            "name": "South Carolina",
            "exchange": 0,
            "race": [0.3, 4.9, 0.1, 29, 2, 62.6, 1.2],
"plan": [15, 70, 14, 0, 1],            
"age": [5, 9, 15, 16, 23, 31, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "South Dakota",
            "exchange": 0,
            "race": [2.5, 1.4, -1, 1.1, 1.6, 91.8, 1.4],
"plan": [12, 72, 8, 8, 1],            
"age": [8, 9, 20, 14, 18, 32, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Tennessee",
            "exchange": 0,
            "race": [0.2, 4.5, -1, 18.5, 2, 73.6, 1.2],
"plan": [16, 72, 8, 4, 0],            
"age": [3, 9, 16, 16, 23, 32, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Texas",
            "exchange": 0,
            "race": [0.3, 13.2, 0.1, 13.8, 33.6, 37.8, 1.3],
"plan": [21, 65, 10, 4, 1],            
"age": [7, 11, 16, 17, 22, 26, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Utah",
            "exchange": 0,
            "race": [0.5, 3.6, 0.6, 1, 6.9, 85.8, 1.6],
"plan": [14, 57, 24, 4, 1],            
"age": [17, 10, 21, 16, 15, 21, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
...
"age": [8, 9, 11, 13, 22, 36, 0]
        ...
        "properties": {
            "name": "Virginia",
            "exchange": 0,
            "race": [0.2, 17.7, 0.1, 22.3, 2.9, 54.9, 1.9],
"plan": [20, 63, 11, 6, 1],            
"age": [7, 10, 18, 17, 21, 26, 0]
        },
        "geometry": {"type": "MultiPolygon",
            "coordinates": [
                [
...
"age": [4, 9, 15, 16, 22, 34, 1]
        ...
        "properties": {
            "name": "West Virginia",
            "exchange": 0,
            "race": [0.1, 1.8, -1, 2.9, 0.7, 93.7, 0.8],
"plan": [12, 67, 21, 0, 0],            
"age": [4, 6, 12, 14, 22, 43, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Wisconsin",
            "exchange": 0,
            "race": [0.4, 3, -1, 6, 3.2, 86.4, 0.9],
"plan": [19, 71, 9, 1, 1],            
"age": [4, 8, 13, 12, 22, 41, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
        ...
        "properties": {
            "name": "Wyoming",
            "exchange": 0,
            "race": [3.5, 1.3, -1, 0.6, 5, 88.3, 1.4],
"plan": [21, 66, 8, 5, 0],            
"age": [9, 8, 19, 15, 18, 31, 0]
        },
        "geometry": {"type": "Polygon",
            "coordinates": [
                [
